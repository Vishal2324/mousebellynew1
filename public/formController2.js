app.controller("formController2",['$scope','$location','$window','$http','$state','fileUpload',function(  $scope , $location, $window, $http,$state,$fileUpload){

	console.log('formController2');

	$state.transitionTo('userform.profile');
